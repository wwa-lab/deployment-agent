...
public record UploadResponseDto(String releaseFlowId, String releaseId, Stage stage, int taskCount) {

    public static UploadResponseDto from(ImportResult result) {
        return new UploadResponseDto(
                result.releaseFlowId(), result.releaseId(), result.stage(), result.taskCount());
    }
}
