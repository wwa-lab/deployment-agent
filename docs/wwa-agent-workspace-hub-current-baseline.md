# WWA Agent Workspace Hub Current Baseline

**Status:** Historical/current implementation reference copied from the pre-packaging README on 2026-06-27.

This document preserves the detailed repository operation and implementation baseline while the root README is simplified for the Atlas Engineering Delivery Hub open-collaboration framework entry.
...
This README reflects the current repository code and the current design baseline in [`docs/05-design/design.md`](05-design/design.md).
...
- create the schema from [`docs/sql/ORACLE_CURRENT_SCHEMA.sql`](sql/ORACLE_CURRENT_SCHEMA.sql), or
...
- Product requirements: [`docs/03-spec/spec.md`](03-spec/spec.md)
- Architecture baseline: [`docs/04-architecture/architecture.md`](04-architecture/architecture.md)
- Detailed design baseline: [`docs/05-design/design.md`](05-design/design.md)
- Remaining implementation work: [`docs/06-tasks/tasks.md`](06-tasks/tasks.md)
- Agent Contribute Dashboard SDD chain:
  [`requirement`](01-requirements/agent-contribute-dashboard-requirement.md),
  [`user stories`](02-user-stories/agent-contribute-dashboard-user-stories.md),
  [`spec`](03-spec/agent-contribute-dashboard-spec.md),
  [`architecture`](04-architecture/agent-contribute-dashboard-architecture.md),
  [`design`](05-design/agent-contribute-dashboard-design.md),
  [`tasks`](06-tasks/agent-contribute-dashboard-tasks.md),
  [`prompts`](07-prompts/agent-contribute-dashboard-prompts.md)
- UAT setup/runbook: [`docs/UAT_RUNBOOK.md`](UAT_RUNBOOK.md)
