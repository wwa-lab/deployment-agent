...
The documents are marked **Backfilled** because the runtime Deployment Agent capability already exists. This slice packages and explains the existing tool accurately as the M6 Deployment-stage Tool entry.

## Source Inputs

| Source | Role |
|---|---|
| User request for M6 Deployment Tool packaging | Primary packaging scope and competition category |
| `README.md` and `README.zh-CN.md` | Public entry points |
...
|---|---|---|---|
| M6-REQ-01 Position the repo as the M6 Deployment Tool | M6-US-01 | Spec FR-01 | README, submission docs |
...
- Prior umbrella framework docs were retained as context and no longer used as the primary competition entry.
