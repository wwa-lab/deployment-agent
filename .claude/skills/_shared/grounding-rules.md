...
**Audience:** Every SDD pipeline skill (`user-story-to-spec`, `spec-to-architecture`, `architecture-to-design`, `design-to-tasks`, `tasks-to-code`, `review-doc-quality`, `review-code-against-design`).
